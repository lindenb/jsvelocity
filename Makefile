...
all_maven_jars = $(sort   ${apache.commons.cli.jars} ${commons.loggging.jars} ${commons.codec.jars} ${apache.velocity.jars}  ${gson.jars})
...
$(1)  : ${htsjdk.jars} \
		...
		$(3) $${apache.commons.cli.jars} $${commons.loggging.jars}
...
$(eval $(call compile-cmd,jsvelocity,com.github.lindenb.jsvelocity.JSVelocity,${apache.velocity.jars} ${commons.codec.jars} ${gson.jars}))
